...
MASTER_PASSWORD = 'super_pentagon_2026' # Одноразовий пароль для Софії
ADMIN_ID = 806035065                   # Твій ID (Артем)
...
def admin_list(message):
    ...
    if message.chat.id == ADMIN_ID or (res and res[0] == 2):
        ...
        if not workers:
            bot.send_message(message.chat.id, "У команді поки немає звичайних працівників.")
            return
